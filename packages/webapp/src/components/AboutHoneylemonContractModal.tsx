...
const AboutHoneylemonContractModal: React.SFC<AboutHoneylemonContractModalProps> = ({ open, onClose }) => (
  <Dialog open={open} onClose={onClose} aria-labelledby="dialog-title" maxWidth='sm' fullWidth>
    ...
    <DialogContent>
      ...
      • The Honeylemon 28-Day Mining Revenue Contract is a forward-like product that settles to the market-wide block reward and fees per Terahash over 28 days as published in the BTC Mining Revenue Index (BTC_MRI_28), with a 125% max revenue cap for the buyer. See Contract Specifications in the Docs. (Hyperlink: https://docs.honeylemon.market/btc-mining-revenue-contract-1)<br/>
      ...
      • Honeylemon Mining Revenue Contracts are executed via a set of Ethereum smart contracts, built upon Market Protocol and 0x Protocol v3. Check out our <Link href='https://docs.honeylemon.market/technical-architecture'>Technical Architecture<OpenInNew fontSize='small' /></Link> in Docs.<br/>
      </Typography>
    </DialogContent>
  </Dialog>
)
