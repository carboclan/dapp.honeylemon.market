    ...
    <DialogContent>
      ...
      <Typography variant='body2'>
        • Decentralized exchanges of your choice:<br />
          ...
          &nbsp;&nbsp;• Aggregators: <Link href='https://1inch.exchange/#' target="_blank" rel='noopener' underline='always'>1inch.exchange<OpenInNew fontSize='small' /></Link>, or <Link href='https://dex.ag/' target="_blank" rel='noopener' underline='always'>Dex.ag<OpenInNew fontSize='small' /></Link><br />
          • Centralized exchanges, such as <Link href='https://www.binance.com/en' target="_blank" rel='noopener' underline='always'>Binance<OpenInNew fontSize='small' /></Link>
      </Typography>
      <br />
      <Typography variant='subtitle2'>
      ...
      <Typography variant='body2'>
        • If you may use Honeylemon more than once or have multiple orders, Create Honeylemon Vault can reduce gas costs and streamline user experience.<br />
        • Create Honeylemon Vault triggers deploying a DSProxy contract, which holds your long/short position tokens on your behalf.
      </Typography>
    </DialogContent>
  </Dialog>
)}
