...
contract Utils {
  function redeemPositionTokens(address marketContractAddress, uint qtyToRedeem) public {
    MarketContract marketContract = MarketContract(marketContractAddress);
    MarketCollateralPool marketCollateralPool = MarketCollateralPool(marketContract.COLLATERAL_POOL_ADDRESS());
