...
contract MarketContractProxy is Ownable {
    ...
    function settle(uint currentIndexValue, uint loobackIndexValue) public onlyHoneyLemonOracle {
    ...
    function deployContract(uint indexValue) onlyOwner (address) public internal {
