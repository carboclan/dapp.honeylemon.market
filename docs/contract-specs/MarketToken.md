# Market Token (MarketToken.sol)

View Source: [contracts/marketprotocol/tokens/MarketToken.sol](../../contracts/marketprotocol/tokens/MarketToken.sol)

**↗ Extends: [UpgradeableToken](UpgradeableToken.md)**

**MarketToken**

Our membership token.  Users must lock tokens to enable trading for a given Market Contract
